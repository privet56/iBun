...
class ParallaxScene: SKScene
{
    ...
    override init(size: CGSize)
    {
        ...
        pathNodeNext.position = CGPoint(x: pathNode.position.x +
                pathNode.size.width,
    ...
    //super: open func update(_ currentTime: TimeInterval)
    override func update(_ currentTime: TimeInterval)
    {
        ...
        self.moveSprite(sprite:distantHillsNode, nextSprite:distantHillsNodeNext,speed:50.0)
        self.moveSprite(sprite:hillsNode, nextSprite:hillsNodeNext, speed:100.0)
        self.moveSprite(sprite:pathNode, nextSprite:pathNodeNext, speed:150.0)
    }
}
